...
uint8_t nodeDeviceEUI[8] = {0xAC, 0x1F, 0x09, 0xFF, 0xFE, 0x06, 0x40, 0x6A};
uint8_t nodeAppEUI[8] = {0x60, 0x81, 0xF9, 0xA8, 0x5A, 0xBD, 0x0B, 0x94};
uint8_t nodeAppKey[16] = {0x34, 0x4F, 0xD2, 0xFE, 0xF4, 0x6C, 0x54, 0x11, 0x1B, 0x3D, 0xD0, 0x3F, 0xE4, 0xAC, 0xB6, 0xD4};
